...
function lineMetrics(errors) {
  ...
  return errors.reduce((vals, _ref) => {
    let message = _ref.message;
    var _ref$location = _ref.location;
    let line = _ref$location.line;
    let col = _ref$location.col;
 ...
 * @return {string}
 */
function formatLine(_ref2, metrics) {
  let rule = _ref2.rule;
...
class ConsoleReporter {
   ...
   */
  report(results) {
    const numErrors = results.reduce((num, _ref3) => {
